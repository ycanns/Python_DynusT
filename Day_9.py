...
## INITAILIZATION
#UE_5iter_500min
#Veh_assign_oneshot_500min
#Veh_Path_assgin_oneshot_500min

# Reading Vehicle trajectory file and Exporting for analysis
f=open('E:\\Research\\DynusT_Learning\\VA_Newtork\\VehTrajectory.dat','r') # Trajectory data to read
s=open('E:\\Research\\DynusT_Learning\\Python_Test\\VehTrjry_Info.txt','w')	# file name you want to write
